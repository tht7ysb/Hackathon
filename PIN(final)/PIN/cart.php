...
if (isset($_SESSION["customer_id"])) {
	...
	//$_SESSION["recept"] = $product_id_array;

	//echo $product_id_array[6];

	//$_SESSION["recept"] = $product_id_array;
	//echo $_SESSION["recept"];
  ...
  <?php include_once("template_header.php");?>
	<div id="pageContent">
		...
		<tr>
			...
			<td width="9%" bgcolor="#aea08e"><strong>Remove</strong></td>
		</tr>
    ...
    <!-- <a class="CheckOut" href="cart.php?cmd=emptycart">Click Here to Empty Your Shopping Cart</a>  -->
			<div style="float:right;;">
				<?php //echo $cartTotalToShowTable; ?>
				</br>
				<?php //echo $shoppingCartButton ?>
			</div>
		...
		<!-- <a class="buttons" href="checkOut.php"  style="float:center"><b>Checkout Now</b></a>		-->
		<?php //echo $shoppingCartButton ?>
